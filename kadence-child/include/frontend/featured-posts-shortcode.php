...
function display_featured_posts_shortcode() {
    ...
    <style>
        ...
        .layout-mode-1 .fp-title { font-size: 38px; }
        ...
        .fp-meta svg {
            width: 14px;
            height: 14px;
            fill: #D40000; /* Icon color (Red match) or use 'currentColor' for gray */
        }
        ...
        .layout-mode-1 .fp-image { height: 500px; }
        .layout-mode-2 .fp-image { height: 350px; }
        .layout-mode-3 .fp-image { height: 250px; }

        @media (max-width: 767px) {
            .layout-mode-1 .fp-image { height: 250px; }
            .layout-mode-1 .fp-title { font-size: 26px; }
        }
    </style>
